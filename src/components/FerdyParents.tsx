      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12">
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-foreground leading-relaxed max-w-4xl mx-auto">
            Ferdy der Fuchs wurde entwickelt, um Kindern wichtige Lebenskompetenzen spielerisch beizubringen. Unsere
            Inhalte fördern nicht nur den Spaß am Lernen, sondern unterstützen auch die sozial-emotionale Entwicklung
            Ihres Kindes.
          </p>
        </div>
        ...
        <div className="hidden lg:grid grid-cols-3 grid-rows-2 gap-8 h-[400px]">
          ...
          <div className="bg-white rounded-2xl p-6 ferdy-shadow-card flex flex-col justify-center">
            <h3 className="text-xl font-bold text-foreground mb-3">{features[0].title}</h3>
          ...
          {/* Top Right */}
          <div className="bg-white rounded-2xl p-6 ferdy-shadow-card flex flex-col justify-center">
            <h3 className="text-xl font-bold text-foreground mb-3">{features[1].title}</h3>
