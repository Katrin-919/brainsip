...
serve(async (req) => {
  ...
  try {
    ...
    const prompt = `Gib mir einen unfreundlichen oder verletzenden Satz, den ein Kind oder Jugendlicher sagen könnte (z. B. "Du bist so nervig!").  
...

{
  "sentence": "..."
    ...
    console.log('Generating bad sentence...');
    ...
    console.log('Generated sentence:', result.sentence);
    ...
    console.error('Error in generate-bad-sentence function:', error);
    return new Response(JSON.stringify({ 
      error: 'Error generating bad sentence',
